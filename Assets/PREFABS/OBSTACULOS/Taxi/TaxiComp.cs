...
public class TaxiComp : MonoBehaviour 
{
	...
	bool Medicion()
	{
		float dist1 = (LevelManager.Instancia.Player1.transform.position - PosIni).magnitude;
		float dist2 = (LevelManager.Instancia.Player2.transform.position - PosIni).magnitude;
